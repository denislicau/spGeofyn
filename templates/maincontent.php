<div id="Content">
	...
	<nav class="sideNavRight col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2">
	    <h4>Location:<br>Park</h4>
	    <p>Address: odensevej 22<br>
	    Visited(last day): 800 times<br>
	    Average visitors(month): 450/day</p>
	</nav>
